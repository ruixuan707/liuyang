...
import com.monco.entity.Customer;
import com.monco.repository.GoodsRepository;
import com.monco.repository.GoodsTypeRepository;
import com.monco.repository.SaleListGoodsRepository;
import com.monco.repository.SaleListRepository;
...
import com.monco.entity.SaleList;
import com.monco.entity.SaleListGoods;
import com.monco.service.SaleListService;
import com.monco.util.StringUtil;
...
public class SaleListServiceImpl implements SaleListService {
    ...
    public float totalByCustomerId(Integer customerId) {
        List<SaleList> saleListList = saleListRepository.totalByCustomerId(customerId);
        float total = 0;
        for (SaleList saleList : saleListList) {
            total = total + saleList.getAmountPayable();
        }
        return total;
    }
